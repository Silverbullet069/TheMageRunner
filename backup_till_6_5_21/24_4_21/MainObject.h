...
public:
   ...
   void set_clips(const int& dis_frame);
   ...
   bool LoadPlayerIdleImg(SDL_Renderer* des);
   bool LoadPlayerWalkLeftImg(SDL_Renderer* des);
   bool LoadPlayerWalkRightImg(SDL_Renderer* des);
...
private:
   /**Ly do tai sao phai co bien rect la vi txt duoc load = SDLCommonFunction::LoadTexture
   Binh thuong su dung BaseObject::LoadImg se khien rect_ trong BaseObject thay doi
   Con ham` SDLCommonFunction::LoadTexture thi khong khien rect_ thay doi */
   SDL_Texture* txt_player_idle_;
   SDL_Rect rect_player_idle_;
   int width_frame_idle_;
   int height_frame_idle_;

   SDL_Texture* txt_player_walk_left_;
   SDL_Rect rect_player_walk_left_;
   int width_frame_left_;
   int height_frame_left_;

   SDL_Texture* txt_player_walk_right_;
   SDL_Rect rect_player_walk_right_;
