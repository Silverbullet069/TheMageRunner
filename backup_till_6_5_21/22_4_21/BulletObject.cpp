...
bool BulletObject::LoadImgBullet(SDL_Renderer* des)
{
   ...
   {
      ret = LoadImg(g_name_skill_main_fire_ball, des, SDL_TRUE, BLACK);
   }
   else if(bullet_type_ == ICE_SHARD)
   {
      ret = LoadImg(g_name_skill_main_ice_shard, des, SDL_FALSE, WHITE);
   }
   else if(bullet_type_ == FIRE_BALL_WISP_LEFT)
   {
      ret = LoadImg(g_name_skill_wisp_fire_ball_left, des, SDL_TRUE, BLACK);
   }
   else if(bullet_type_ == FIRE_BALL_WISP_RIGHT)
   {
      ret = LoadImg(g_name_skill_wisp_fire_ball_right, des, SDL_TRUE, BLACK);
   }
