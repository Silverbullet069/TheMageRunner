...
const int THREAT_TOTAL_NUM_EACH_TYPE = 5;
...
//Main
const std::string g_name_main_obj_move_left = "resource//Main//Real wizard//Tile//128x128//png 16fr//walk_left_16fr.png";
const std::string g_name_main_obj_move_right = "resource//Main//Real wizard//Tile//128x128//png 16fr//walk_right_16fr.png";
...
const std::string g_name_skill_main_fire_ball = "resource//Main//Real wizard//Fireball//Fireball_96x64.png";
const std::string g_name_skill_main_ice_shard = "resource//Main//Real wizard//Iceshard//64x64//7.png";
...
#define EPSILON_Y 20 // Sai so rieng de de xu ly va cham mat dat
