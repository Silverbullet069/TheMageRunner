...
int main(int argc, char* argv[])
{
   ...
   //Khai bao BaseObject
      ...
      ret = back_ground_1.LoadImg(g_name_back_ground_1, g_renderer, SDL_FALSE, WHITE);
      if(!ret)  { printf("Failed to load background 1!"); return 0;}

      ret = back_ground_2.LoadImg(g_name_back_ground_2, g_renderer, SDL_FALSE, WHITE);
      if(!ret)  { printf("Failed to load background 2!"); return 0;}

      ret = back_ground_3.LoadImg(g_name_back_ground_3, g_renderer, SDL_FALSE, WHITE);
