...
int SDLCommonFunction::ShowMenu(SDL_Texture* menu, TTF_Font* font, SDL_Renderer* des)
{
   ...
   text_menu[0].SetColor(WHITE);
   text_menu[0].SetPosXY(pos_arr[0].x, pos_arr[0].y);

   text_menu[1].SetText("Exit");
   text_menu[1].SetColor(WHITE);
   text_menu[1].SetPosXY(pos_arr[1].x, pos_arr[1].y);
