...
bool MainObject::LoadPlayerIdleImg(SDL_Renderer* des)
{
   ...
   if(txt_player_idle_ != NULL)
   {
      ...
      //Phuc vu trang thai xuat hien dau tien cua nhan vat, khong co tac dung khi su dung SDLCommonFunction::SetObject()
      width_frame_ = width_frame_idle_;
      height_frame_ = height_frame_idle_;
   }
   else
   {
