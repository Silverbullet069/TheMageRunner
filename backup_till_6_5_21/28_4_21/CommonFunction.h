...
const std::string g_name_skill_main_fire_ball = "resource//Main//Fireball//Fireball.png";
const std::string g_name_skill_main_ice_shard = "resource//Main//Ice Shard//Ice_shard.png";

//Threat
const std::string g_name_threat_fire_wisp_move_left = "resource//Threat//Elemental wisp//Fire wisp//move_left_512x64.png";
const std::string g_name_threat_fire_wisp_move_right = "resource//Threat//Elemental wisp//Fire wisp//move_right_512x64.png";
const std::string g_name_threat_fire_wisp_idle = "resource//Threat//Elemental wisp//Fire wisp//idle_461x64.png";
const std::string g_name_threat_fire_wisp_die = "resource//Threat//Elemental wisp//Fire wisp//die_512x64.png";
const std::string g_name_skill_wisp_fire_ball_left = "resource//Threat//Elemental wisp//Fire wisp//fire_ball_left.png";
const std::string g_name_skill_wisp_fire_ball_right = "resource//Threat//Elemental wisp//Fire wisp//fire_ball_right.png";
