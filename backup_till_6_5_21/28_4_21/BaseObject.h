...
public:
   ...
   chuyen doi luan phien giua cac texture, tat game cac texture nay se bi huy di, dong thoi
   object ban dau truoc khi su dung ham` nay cung se duoc giai phong => khong gay ra that thoat */
