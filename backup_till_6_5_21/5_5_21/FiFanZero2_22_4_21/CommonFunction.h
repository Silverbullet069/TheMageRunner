...
//Screen effect
const int ALPHA_BLEND_RANGE = 50;
const int FADING_DELAY_TIME = 30;
...
//const std::string g_name_fairy_vanish_forward = fairy_directory + "";
