...
void FairyObject::HandleConvo(SDL_Renderer* des, SDL_Event& events)
{
   if(is_convo_run_ == true)
   {
      ...
      case 0:
      {
         ...
         fairy_convo_.SetPosXY((SCREEN_WIDTH - fairy_convo_.get_total_width())/2 , this->rect_.y + 300);
         fairy_convo_.RenderTypingAnimationByFrame(des, events, convo_order_);
      }
         break;
      ...
      case 1:
      {
         ...
         fairy_convo_.SetPosXY((SCREEN_WIDTH - fairy_convo_.get_total_width())/2, this->rect_.y + 400);
         fairy_convo_.RenderTypingAnimationByFrame(des, events, convo_order_);
      }
         break;
      ...
      case 2:
      {
         ...
         {
            fairy_convo_.SetColor(WHITE);
            fairy_convo_.SetTextTotal("Let's go through the basic. Do you want to enter tutorials ?");
            fairy_convo_.CreateSurfaceTextTotal(g_font_text);
            is_set_convo_[2] = true;
         }
         fairy_convo_.SetPosXY((SCREEN_WIDTH - fairy_convo_.get_total_width())/2, this->rect_.y + 500);
         fairy_convo_.RenderTypingAnimationByFrame(des, events, convo_order_);
      }
         break;
