...
const int THREAT_MAX_PATROL = 60;
const int THREAT_TOTAL_NUM_EACH_TYPE = 10;

const int THREAT_BULLET_MARGINS_X_VAL = 10;
const int THREAT_BULLET_MARGINS_Y_VAL = 10;
const int THREAT_BULLET_VELOCITY = 15;
const int THREAT_BULLET_MAX_RANGED = 400;
...
const std::string g_name_skill_wisp_fire_ball = "resource//Threat//Elemental wisp//Fire wisp//fire_ball.png";
